...
/**
* The tracker file that the server will create will look as shown below:
* Filename: movie1.avi 
* Filesize: 109283519 
* Description: Ghost and the Darkness, DVD Rip 
* MD5: c68c2ee8bfca4e898b396e7a935a1d92  
* #list of peers follows next <ip address of the peer>:<port number>:<start byte>:<end byte>:<time stamp>   
...
int main(int argc, char **argv) {
  ...
  //Prepare the server sockaddr_in structure with default port (3456)
...
char* handleCommandsClient(char* command) {
  ...
  } else if(strcmp("update_tracker", token) == 0) {
